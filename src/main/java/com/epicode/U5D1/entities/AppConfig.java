...
public class AppConfig {
    ...
    public Ordine ordineBean(@Value("${costo.coperto}") double costoCoperto) {
        ...
        itemList.add(pizzaMargheritaBean());
        itemList.add(pizzaSalamiXlBean());
        itemList.add(wineBean());
        itemList.add(lemonadeBean());
        itemList.add(waterBean());
        return new Ordine(1, StatoOrdine.SERVITO, tavolo1Bean(), itemList, costoCoperto);
    }

    @Bean("ordine2")
    public Ordine ordine2Bean(@Value("${costo.coperto}") double costoCoperto) {
        List<Item> itemList = new ArrayList<>();
        itemList.add(pizzaMargheritaBean());
        itemList.add(pizzaMargheritaBean());
        itemList.add(pizzaSalamiXlBean());
